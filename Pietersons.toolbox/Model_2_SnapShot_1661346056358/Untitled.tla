...
TypeOK == s0 \in 0..7 /\ s1 \in 0..7 /\ turn \in 0..1 /\inst0 \in BOOLEAN /\ inst1 \in BOOLEAN
...
P34 == (s0=3 /\ s0' = 4) /\turn'=0 /\ UNCHANGED<<inst0,inst1>>
P44 == (s0=4 ) /\turn=1 /\inst1=TRUE /\ UNCHANGED<<turn,inst0,inst1,s0>>
P45 == (s0=4 /\ s0' = 5) /\ (turn=0 \/inst1=FALSE ) /\ UNCHANGED<<turn,inst0,inst1>>
...
Q34 == (s1=3 /\ s1' = 4) /\ turn'=0 /\ UNCHANGED<<inst0,inst1>>
Q44 == (s1=4 ) /\ turn=0 /\inst0=TRUE /\ UNCHANGED<<inst0,inst1,turn,s1>>
Q45 == (s1=4 /\ s1' = 5) /\(turn=1 \/inst0=FALSE )/\ UNCHANGED<<inst0,inst1,turn>>
...
\* Last modified Wed Aug 24 18:30:51 IST 2022 by 112001042
