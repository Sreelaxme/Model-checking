...
P22 == (l0 =2)  /\ (sem=0) /\ UNCHANGED<<sem,l0>>
...
P == P01 \/ P12 \/ P22\/ P23 \/ P34 \/ P45 \/ P50\/Pstall

Q01 == (l1=0) /\ (l1' = 1) /\ UNCHANGED<<sem>>
Q12 == (l1=1) /\ (l1' = 2) /\ UNCHANGED<<sem>>
Q22 == (l1 =2)  /\ (sem=0) /\ UNCHANGED<<sem,l1>>
...
Q == Q01 \/ Q12 \/ Q22 \/ Q23 \/ Q34 \/ Q45 \/ Q50 \/Qstall
...
StrongFairspec == Init /\ [][Next]_vars /\ StrongFairness 
            
            
            
=============================================================================
\* Modification History
\* Last modified Wed Sep 21 19:01:19 IST 2022 by 112001042
